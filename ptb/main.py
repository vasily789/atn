...
parser.add_argument('--mode', type = str, default= 'atn')
...
model = model.RNNModel(args.model, ntokens, args.emsize, args.nhid, args.nlayers, args.dropout, args.dropouth, args.dropouti, args.dropoute, args.wdrop, args.tied, args.max_length)
###
if args.resume:
...
def evaluate(data_source, batch_size=10):
    ...
    for i in range(0, data_source.size(0) - 1, args.bptt):
        ...
        if args.mode == 'atn':
            model.rnns[0].cell_0.norm_hh.reset_in_memory()
            model.rnns[0].cell_0.norm_ih.reset_in_memory()
            model.rnns[0].cell_0.norm_c.reset_in_memory()
...
def train():
    ...
    while i < train_data.size(0) - 1 - 1:
        ...
        # Starting each batch, we detach the hidden state from hmow it was previously produced.
